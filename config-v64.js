window.AL_IHSAN_CONFIG = Object.freeze({
  ...
  timezoneOffset: 7,
  release: "prayer-timing-v107-20260926",
  ...
  prayerMode: Object.freeze({
    ...
    defaults: Object.freeze({
      Subuh: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 8, khutbahMinutes: 0, prayerMinutes: 10, returnScene: "dashboard" }),
      Dzuhur: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 3, khutbahMinutes: 0, prayerMinutes: 5, returnScene: "dashboard" }),
      Ashar: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 3, khutbahMinutes: 0, prayerMinutes: 5, returnScene: "dashboard" }),
      Maghrib: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 3, khutbahMinutes: 0, prayerMinutes: 7, returnScene: "dashboard" }),
      Isya: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 8, khutbahMinutes: 0, prayerMinutes: 7, returnScene: "dashboard" }),
