window.AL_IHSAN_CONFIG = Object.freeze({
  ...
  prayerMode: Object.freeze({
    ...
    defaults: Object.freeze({
      Subuh: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 15, khutbahMinutes: 0, prayerMinutes: 10, returnScene: "dashboard" }),
      Dzuhur: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 10, khutbahMinutes: 0, prayerMinutes: 10, returnScene: "dashboard" }),
      Ashar: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 10, khutbahMinutes: 0, prayerMinutes: 10, returnScene: "dashboard" }),
      Maghrib: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 5, khutbahMinutes: 0, prayerMinutes: 10, returnScene: "dashboard" }),
      Isya: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 10, khutbahMinutes: 0, prayerMinutes: 10, returnScene: "dashboard" }),
      Jumat: Object.freeze({ active: true, azanMinutes: 3, iqamahMinutes: 0, khutbahMinutes: 30, prayerMinutes: 10, returnScene: "dashboard" })
    }),
