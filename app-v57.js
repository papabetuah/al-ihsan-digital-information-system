...
const E={
  ...
  prayerName:$("prayerModePrayer"),prayerCountdown:$("prayerModeCountdown"),prayerMessage:$("prayerModeMessage"),prayerDuaCard:$("prayerDuaCard"),prayerAdvice1:$("prayerAdvice1"),prayerAdvice2:$("prayerAdvice2"),prayerAdvice3:$("prayerAdvice3"),
...
function prayerAdvice(state){
  ...
  if(state.phase==="dua")return["Baca doa bersama","Bimbing anak-anak untuk menghafal","Tetap tenang menunggu "+(state.prayerName==="Jumat"?"khutbah":"iqamah")];
...
function getPrayerPreviewState(now){
  ...
  if(!["azan","dua","iqamah","khutbah","prayer"].includes(phase))phase=prayerName==="Jumat"?"khutbah":"iqamah";
