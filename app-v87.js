...
function applyRamadanRows(rows){
  ...
  ramadanSettings={
    ...
    speakerName:String(row["Nama Penceramah"]||row["Penceramah"]||C.prayerMode?.ramadanDefaults?.speakerName||"Nama Penceramah").trim(),
...
function renderPrayerMode(state,now){
  ...
  if(E.prayerRamadanSpeakerName&&showRamadanSpeaker)E.prayerRamadanSpeakerName.textContent=String(ramadanSettings.speakerName||"Nama Penceramah").trim()||"Nama Penceramah";
